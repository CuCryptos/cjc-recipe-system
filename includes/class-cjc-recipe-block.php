...
class CJC_Recipe_Block {
    ...
    public static function enqueue_editor_assets() {
        $asset_file = CJC_RECIPE_DIR . 'build/recipe-editor.asset.php';
        ...
        wp_enqueue_script(
            'cjc-recipe-editor',
            CJC_RECIPE_URL . 'build/recipe-editor.js',
            $asset['dependencies'],
            $asset['version'],
            true
        );
        ...
        wp_enqueue_style(
            ...
            CJC_RECIPE_URL . 'build/recipe-editor.css',
            array(),
            $asset['version']
        );
    ...
    public static function enqueue_frontend_assets() {
        ...
        $asset_file = CJC_RECIPE_DIR . 'build/recipe.asset.php';
        ...
        wp_enqueue_script(
            'cjc-recipe-frontend',
            CJC_RECIPE_URL . 'build/recipe.js',
            $asset['dependencies'],
            $asset['version'],
            true
        );
        ...
        wp_enqueue_style(
            'cjc-recipe-style',
            CJC_RECIPE_URL . 'build/recipe.css',
            array(),
            $asset['version']
        );
    }
        ...
        <article class="cjc-recipe-static" itemscope itemtype="https://schema.org/Recipe">
            ...
            <div class="cjc-recipe-meta">
                <?php if ( ! empty( $data['prep_time'] ) ) : ?>
                    <span class="cjc-recipe-prep-time">
                        <strong><?php esc_html_e( 'Prep:', 'cjc-recipe-system' ); ?></strong>
                ...
                <?php if ( ! empty( $data['cook_time'] ) ) : ?>
                    <span class="cjc-recipe-cook-time">
                        <strong><?php esc_html_e( 'Cook:', 'cjc-recipe-system' ); ?></strong>
                ...
                <?php if ( ! empty( $data['total_time'] ) ) : ?>
                    <span class="cjc-recipe-total-time">
                        <strong><?php esc_html_e( 'Total:', 'cjc-recipe-system' ); ?></strong>
                ...
                <?php if ( ! empty( $data['yield'] ) ) : ?>
                    <span class="cjc-recipe-yield">
                        <strong><?php esc_html_e( 'Servings:', 'cjc-recipe-system' ); ?></strong>
            ...
            <?php if ( ! empty( $data['ingredients'] ) ) : ?>
                <section class="cjc-recipe-ingredients">
                    <h3><?php esc_html_e( 'Ingredients', 'cjc-recipe-system' ); ?></h3>
            ...
            <?php if ( ! empty( $data['instructions'] ) ) : ?>
                <section class="cjc-recipe-instructions">
                    <h3><?php esc_html_e( 'Instructions', 'cjc-recipe-system' ); ?></h3>
            ...
            <?php if ( ! empty( $data['notes'] ) ) : ?>
                <section class="cjc-recipe-notes">
                    <h3><?php esc_html_e( 'Notes', 'cjc-recipe-system' ); ?></h3>
            ...
            <?php if ( $has_nutrition ) : ?>
                <section class="cjc-recipe-nutrition" itemprop="nutrition" itemscope itemtype="https://schema.org/NutritionInformation">
                    <h3><?php esc_html_e( 'Nutrition', 'cjc-recipe-system' ); ?></h3>
                    <dl>
                        <?php
