...
class CJC_Recipe_Migration {
    ...
    public static function add_migration_page() {
        add_submenu_page(
            ...
            __( 'Migrate from Tasty Recipes', 'cjc-recipe-system' ),
            __( 'Migration', 'cjc-recipe-system' ),
            'manage_options',
    ...
    public static function render_migration_page() {
        ...
        ?>
        <div class="wrap">
            <h1><?php esc_html_e( 'Migrate from Tasty Recipes', 'cjc-recipe-system' ); ?></h1>
            ...
            <div class="card">
                <h2><?php esc_html_e( 'Migration Status', 'cjc-recipe-system' ); ?></h2>
                <p>
                    <strong><?php esc_html_e( 'Tasty Recipes found:', 'cjc-recipe-system' ); ?></strong>
                    <?php echo intval( $tasty_count ); ?>
                </p>
                <p>
                    <strong><?php esc_html_e( 'Already migrated:', 'cjc-recipe-system' ); ?></strong>
                    <?php echo intval( $migrated_count ); ?>
                </p>
                <p>
                    <strong><?php esc_html_e( 'Remaining:', 'cjc-recipe-system' ); ?></strong>
            ...
            <div class="card">
                <h2><?php esc_html_e( 'Run Migration', 'cjc-recipe-system' ); ?></h2>
                <p><?php esc_html_e( 'This will copy all Tasty Recipes to CJC Recipes and update post content to use the new blocks.', 'cjc-recipe-system' ); ?></p>

                <p>
                    <label>
                        <input type="checkbox" id="cjc-dry-run" checked />
                        <?php esc_html_e( 'Dry run (preview changes without saving)', 'cjc-recipe-system' ); ?>
                    </label>
                </p>
                ...
                <p>
                    <label>
                        ...
                        <?php esc_html_e( 'Update post content to replace Tasty Recipe blocks', 'cjc-recipe-system' ); ?>
                    </label>
                </p>

                <p>
                    <button type="button" id="cjc-start-migration" class="button button-primary">
                        <?php esc_html_e( 'Run Migration', 'cjc-recipe-system' ); ?>
                    </button>
                </p>
            ...
            <div class="card">
                <h2><?php esc_html_e( 'Convert Regular Posts to Recipes', 'cjc-recipe-system' ); ?></h2>
                <p><?php esc_html_e( 'Scan posts in recipe categories and convert them to CJC Recipes by parsing the content.', 'cjc-recipe-system' ); ?></p>
                ...
                <p>
                    <strong><?php esc_html_e( 'Recipe categories:', 'cjc-recipe-system' ); ?></strong>
                    <?php echo esc_html( implode( ', ', $recipe_categories ) ); ?>
                </p>
                <p>
                    <strong><?php esc_html_e( 'Posts to convert:', 'cjc-recipe-system' ); ?></strong>
                ...
                <p>
                    <label>
                        ...
                        <?php esc_html_e( 'Dry run (preview without saving)', 'cjc-recipe-system' ); ?>
                    </label>
                </p>

                <p>
                    <button type="button" id="cjc-start-convert" class="button button-primary">
                        <?php esc_html_e( 'Convert Posts', 'cjc-recipe-system' ); ?>
                    </button>
                </p>
            ...
            <div class="card">
                <h2><?php esc_html_e( 'WP-CLI Commands', 'cjc-recipe-system' ); ?></h2>
                <p><?php esc_html_e( 'You can also run migration via WP-CLI:', 'cjc-recipe-system' ); ?></p>
                <pre>
...
wp cjc-recipe verify
    ...
    public static function handle_migration_request() {
        if ( ! current_user_can( 'manage_options' ) ) {
            wp_die( __( 'Unauthorized', 'cjc-recipe-system' ) );
        }
