...
class CJC_Recipe_Meta {
    ...
    public static function get_nutrition_labels() {
        return array(
            'serving_size'    => __( 'Serving Size', 'cjc-recipe-system' ),
            'calories'        => __( 'Calories', 'cjc-recipe-system' ),
            'sugar'           => __( 'Sugar', 'cjc-recipe-system' ),
            'sodium'          => __( 'Sodium', 'cjc-recipe-system' ),
            'fat'             => __( 'Fat', 'cjc-recipe-system' ),
            'saturated_fat'   => __( 'Saturated Fat', 'cjc-recipe-system' ),
            'unsaturated_fat' => __( 'Unsaturated Fat', 'cjc-recipe-system' ),
            'trans_fat'       => __( 'Trans Fat', 'cjc-recipe-system' ),
            'carbohydrates'   => __( 'Carbohydrates', 'cjc-recipe-system' ),
            'fiber'           => __( 'Fiber', 'cjc-recipe-system' ),
            'protein'         => __( 'Protein', 'cjc-recipe-system' ),
            'cholesterol'     => __( 'Cholesterol', 'cjc-recipe-system' ),
        );
    }
    ...
    public static function get_diet_options() {
        return array(
            ''            => __( 'N/A', 'cjc-recipe-system' ),
            'Diabetic'    => __( 'Diabetic', 'cjc-recipe-system' ),
            'Gluten Free' => __( 'Gluten Free', 'cjc-recipe-system' ),
            'Halal'       => __( 'Halal', 'cjc-recipe-system' ),
            'Hindu'       => __( 'Hindu', 'cjc-recipe-system' ),
            'Kosher'      => __( 'Kosher', 'cjc-recipe-system' ),
            'Low Calorie' => __( 'Low Calorie', 'cjc-recipe-system' ),
            'Low Fat'     => __( 'Low Fat', 'cjc-recipe-system' ),
            'Low Lactose' => __( 'Low Lactose', 'cjc-recipe-system' ),
            'Low Salt'    => __( 'Low Salt', 'cjc-recipe-system' ),
            'Vegan'       => __( 'Vegan', 'cjc-recipe-system' ),
            'Vegetarian'  => __( 'Vegetarian', 'cjc-recipe-system' ),
        );
    }
}
